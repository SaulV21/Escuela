...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-01-2023 a las 22:32:22
...
CREATE TABLE `alumnos` (
  ...
  `CIUDADRES` varchar(45) DEFAULT NULL,
  ...
  `SISRES` varchar(45) DEFAULT 'APECS',
  `SISFECHA` datetime DEFAULT NULL,
  `CSLTKO` varchar(250) DEFAULT NULL
...
('asw12', '1404', '', '', NULL, '', '', '', '', '', '', '', '', '', '', '', '', 0x75706c6f6164732f313637353139393736355f524f532e6a7067, 'APECS', '2023-01-31 10:01:25', ''),
('CD-33', '99999', 'JUAN', 'MENDOZA', '2002-11-25', 'VINCES', 'M', 'MARIO', 'XXX', 'MARIA', 'XXXX', 'XXXX', 'XXXXX', '0987655', '77686867', 'XXXX', 'XXXXXX', 0x75706c6f6164732f313637353139393932345f43442d33332e6a7067, 'APECS', '2023-01-31 10:01:44', 'JHJ'),
('UEC-1', '0350506192', 'Daysi Isabella', 'Beltrán Guallpa', NULL, '', 'F', '', '', '', '', '', '', '0960603059', '', '', 'N', 0x75706c6f6164732f313637353139393339345f464f2e6a7067, 'APECS', NULL, ''),
...
CREATE TABLE `aopres` (
  `pork` varchar(10) NOT NULL,
  `psoono` varchar(145) DEFAULT NULL,
  `conrax` varchar(15) DEFAULT NULL,
  `apesss` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
CREATE TABLE `cursos` (
  ...
  `PROMOVIDO` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
CREATE TABLE `materias` (
  ...
  `TIPO` varchar(45) NOT NULL DEFAULT 'CUANTITATIVA',
...
CREATE TABLE `matriculas` (
  ...
  `REFERENCIA` varchar(45) DEFAULT NULL,
  `SYSRES` varchar(150) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
CREATE TABLE `matricula_detalle` (
  `MATRICULA` int(11) NOT NULL,
  `MATERIA` varchar(45) NOT NULL,
  `MEJORAPROM` decimal(6,2) DEFAULT 0.00,
  `PROMANUAL` decimal(6,2) DEFAULT 0.00,
  `SUPLETORIO` decimal(6,2) DEFAULT 0.00,
  `REMEDIAL` decimal(6,2) DEFAULT 0.00,
  `GRACIA` decimal(6,2) DEFAULT 0.00,
  `PROMOCION` varchar(45) DEFAULT NULL COMMENT 'APRUEBA\nREPRUEBA'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
CREATE TABLE `notasql` (
  `MATRICULA` int(11) NOT NULL,
  `MATERIA` varchar(45) NOT NULL,
  `P1Q1` varchar(10) DEFAULT NULL,
  `P2Q1` varchar(10) DEFAULT NULL,
  `P3Q1` varchar(10) DEFAULT NULL,
  `NQ1` varchar(10) DEFAULT NULL,
  `P1Q2` varchar(10) DEFAULT NULL,
  `P2Q2` varchar(10) DEFAULT NULL,
  `P3Q2` varchar(10) DEFAULT NULL,
  `NQ2` varchar(10) DEFAULT NULL,
...
CREATE TABLE `parametros` (
  ...
  `valor_texto` varchar(250) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
('df', '0101', 'prueba', '', '', '', NULL, NULL, '', '', '', '', 'ACTIVO');
...
--
-- Indices de la tabla `fbnotas`
--
ALTER TABLE `fbnotas`
  ADD PRIMARY KEY (`PERIODO`,`NOTA`),
...
ALTER TABLE `matricula_detalle`
  ...
  ADD KEY `MATRICULADFK4_idx` (`MEJORAPROM`);
...
--
ALTER TABLE `matriculas`
  MODIFY `NUMEROMATRICULA` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9863;
...
--
ALTER TABLE `notasql`
  ADD CONSTRAINT `fkmateri201` FOREIGN KEY (`MATERIA`) REFERENCES `materias` (`MATERIA`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fkmatri201` FOREIGN KEY (`MATRICULA`) REFERENCES `matriculas` (`NUMEROMATRICULA`) ON UPDATE CASCADE;
